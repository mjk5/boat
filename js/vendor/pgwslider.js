...
;(function($){
    $.fn.pgwSlider = function(options) {
        ...
        var setup = function() {
            ...
            pgwSlider.plugin.prepend('<div class="ps-current"><ul></ul><span class="ps-caption"></span><span class="ps-caption-desc"></span></div>');
        ...
        var finishElement = function(element) {
          ...
          if (element.description) {
                elementTextDesc += '<b>' + element.description + '</b>';
                      }
            ...
            if (elementText != '') {
                ...
                if (typeof pgwSlider.plugin.find('.ps-caption').fadeIn == 'function') {
                  ...
                  pgwSlider.plugin.find('.ps-caption-desc').html(elementTextDesc);
                    pgwSlider.plugin.find('.ps-caption').fadeIn(pgwSlider.config.transitionDuration / 2);
                  pgwSlider.plugin.find('.ps-caption-desc').fadeIn(pgwSlider.config.transitionDuration / 2);
                } else {
                    pgwSlider.plugin.find('.ps-caption').html(elementText);
                  pgwSlider.plugin.find('.ps-caption-desc').html(elementTextDesc);
